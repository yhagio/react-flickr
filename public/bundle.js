...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsSearchBar = __webpack_require__(158);

	var _componentsSearchBar2 = _interopRequireDefault(_componentsSearchBar);

	var _componentsPhotos = __webpack_require__(162);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(_componentsSearchBar2['default'], { _getPhotos: this.handleGetPhotos }),
	        _react2['default'].createElement(_componentsPhotos2['default'], { data: this.state.photos })
	      );
	    }
	  }]);
	...
	var SearchBar = (function (_React$Component) {
	  ...
	  _createClass(SearchBar, [{
	    ...
	    value: function handleSubmit(e) {
	      ...
	      var searchKeyword = this.refs.photoKeyword.getDOMNode().value;
	      this.refs.photoKeyword.getDOMNode().value = '';

	      var url = 'https://api.flickr.com/services/rest/?api_key=' + apiKey + '&method=flickr.photos.search&format=json&nojsoncallback=1&&per_page=20&page=1&text=' + searchKeyword;
	      _superagent2['default'].get(url).end((function (err, res) {
	        if (err) throw err;
	        _this.props._getPhotos(res.body.photos.photo);
	      }).bind(this));
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement('input', { type: 'text', className: '', ref: 'photoKeyword' }),
	          _react2['default'].createElement(
	            'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Photos = (function (_React$Component) {
	  ...
	  function Photos() {
	    ...
	    _get(Object.getPrototypeOf(Photos.prototype), "constructor", this).apply(this, arguments);
	  }
