...
/***/ function(module, exports, __webpack_require__) {
	...
	describe('Header', function () {
	  ...
	  beforeEach(function () {
	    component = _reactAddonsTestUtils2.default.renderIntoDocument(_react2.default.createElement(_Header2.default, null));
	  });

	  it('should have "Built with" as the childnode innerHTML', function () {
	    expect(_reactDom2.default.findDOMNode(component).childNodes[0].innerHTML).toContain("React Flickr");
	  });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	describe('Footer', function () {
	  var component = undefined;
	  beforeEach(function () {
	    component = _reactAddonsTestUtils2.default.renderIntoDocument(_react2.default.createElement(_Footer2.default, null));
	  });

	  it('should have "React Flickr" as the childnode innerHTML', function () {
	    expect(_reactDom2.default.findDOMNode(component).childNodes[0].innerHTML).toContain("Built with");
	    expect(_reactDom2.default.findDOMNode(component).childNodes[0].innerHTML).toContain("Yuichi Hagio");
	  });
	});
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "span",
	            null,
	            _react2.default.createElement("img", { className: "heartIcon", src: __webpack_require__(165), alt: "heart icon" })
	          ),
	          " Yuichi Hagio"
	        )
	      );
...
/***/ function(module, exports) {
	...
	module.exports = "data:image/png;base64,"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Photos = __webpack_require__(167);
	      ...
	      if (this.state.mounted) {
	        photoNodes = this.props.data.map(function (photo) {
	          if (photo) {
	            ...
	            return _react2.default.createElement(
	              "a",
	              { href: source, key: id, target: "_blank", className: "imageBox" },
	...
	var SearchBar = (function (_React$Component) {
	  ...
	  _createClass(SearchBar, [{
	    ...
	    value: function handleSubmit(e) {
	      ...
	      var searchKeyword = this.refs.photoKeyword.value;
	      ...
	      fetch(url).then(function (response) {
	        ...
	        _this2.props._getPhotos(data.photos.photo);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          { className: 'title' },
	          'React ',
	          _react2.default.createElement('img', { className: 'heartIconTop', src: __webpack_require__(165), alt: 'heart icon' }),
	          ' Flickr'
	        ),
	        _react2.default.createElement(
	          'form',
